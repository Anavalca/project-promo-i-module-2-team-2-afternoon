...
function savesInfoLocalStorage(evt){
...
nameInputElem.addEventListener('keyup',savesInfoLocalStorage);
professionInputElem.addEventListener('keyup',savesInfoLocalStorage);
addImageInputElem.addEventListener('keyup',savesInfoLocalStorage);
emailInputElem.addEventListener('keyup',savesInfoLocalStorage);
phoneInputElem.addEventListener('keyup',savesInfoLocalStorage);
linkedinInputElem.addEventListener('keyup',savesInfoLocalStorage);
githubInputElem.addEventListener('keyup',savesInfoLocalStorage);
